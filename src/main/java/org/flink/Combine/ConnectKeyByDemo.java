...
public class ConnectKeyByDemo {
    public static void main(String[] args) throws Exception {
        ...
        ///匿名内部类写法
//                connect.keyBy(new KeySelector<Tuple2<Integer, String>, Integer>() {
//                    @Override
...
//                });
        ...
        SingleOutputStreamOperator<String> result = connectKey.process(
                new CoProcessFunction<Tuple2<Integer, String>, Tuple3<Integer, String, Integer>,
                        String>() {
                    ...
                    @Override
                    public void processElement1(Tuple2<Integer, String> value, Context ctx,
